...
def test_compliance_1(nelx, nely, volfrac,
    ...
    """
    #
    _, _, _, obj_ref = main(nelx=nelx, nely=nely, volfrac=volfrac, 
                      rmin=rmin, ft=ft,
...
def test_assembly(nelx, nely, nelz, volfrac,
    ...
    """
    #
    _, _, _, obj_ref = main(nelx=nelx, nely=nely, nelz=nelz, volfrac=volfrac, #penal=3.0,
                      rmin=rmin, ft=ft,
                      filter_mode="matrix",optimizer="oc",
                      bcs=bcs,
                      lin_solver_kw = {"name": "scipy-direct"},
                      output_kw = {"file": None,
                                   ...
                                   "profile": False})
    #
    _, _, _, obj = main(nelx=nelx, nely=nely, nelz=nelz, volfrac=volfrac, #penal=3.0,
